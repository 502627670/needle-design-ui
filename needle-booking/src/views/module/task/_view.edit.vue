            ...
            <el-col v-for="prop in moduleProps" :key="prop.prop" :xs="24" 
              ...
              <template v-if="!isHideInEdit(prop.ruleType)">
                <el-form-item :label="prop.name" :prop="prop.prop">
                  ...
                  <FormFK v-else-if="prop.feature==='FK'" :moduleProp="prop" v-model="dataForm[prop.prop]" :showValue="dataForm[prop.showPath]" :readonly="isNoUpdate(prop.ruleType)"></FormFK> 
