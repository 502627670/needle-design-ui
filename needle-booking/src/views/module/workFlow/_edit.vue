...
import  { getTaskModule, findTaskModules, getEntity, update,remove, isShowInRow,
  isNoUpdate, isRequired, isID, isAuditProp, isSystemProp, isHideInEdit } from '@/api/example'
      ...
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          ...
          if(selectModule) {
            ...
            let selectedProp = this.selectedTaskModule.props.find(mp => mp.prop === selectProp)
            let selectPropName = selectedProp ? selectedProp.name : ''
          ...
          let params = {}
          this.moduleProps.forEach(mp => {
            if(!this.isSystemProp(mp.ruleType) || this.isID(mp.ruleType)) {
