<template>
  <div class="example-list-container">
    ...
    <el-dialog :visible.sync="dialogEditVisible" @open="openEditDialog" 
      ...
      <!-- <div slot="title">
        标题
        <el-button class="fullscreen" @click="fullscreen=!fullscreen">
...
<script>
  ...
  import  { findList, remove, execute, isHideInList, isHideInInfo, 
    isAuditProp, HIDE_LIST, columnMinWidth, 
    isListProp, isShowInRow, isAbsoluteFile } from '@/api/example'
