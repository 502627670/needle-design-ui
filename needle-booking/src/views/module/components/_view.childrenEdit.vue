      ...
      <template slot-scope="scope">
        <el-form ref="ruleForm" label-width="150px" style="max-width:1200px;">
          <el-row :gutter="0">
            ...
            <el-col v-if="!isHideInInfo(prop.ruleType) && !isAuditProp(prop.ruleType) && !isSystemProp(prop.ruleType)" 
...
import  { findList, getEntity, create, update, remove, isRequired, isAuditProp, 
  isHideInList, isHideInForm, isHideInEdit, isHideInInfo, isID, isSystemProp, 
